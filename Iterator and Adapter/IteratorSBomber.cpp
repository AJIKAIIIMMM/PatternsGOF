...
class IIterator : public SBomber {
public:
    virtual bool hasNext() const = 0;
    virtual vector<Bomb*> FindAllBombs() = 0;
};
...
private:
    ...
    int position = 0;
public:
    BombIterator(const vector<Bomb*> &vecBombs) : vecBombs(vecBombs) {}
